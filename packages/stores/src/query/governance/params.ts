...
export class ObservableQueryGovParamTally extends ObservableChainQuery<
  GovParamsTally
> {
...
export class ObservableQueryGovParamVoting extends ObservableChainQuery<
  GovParamsVoting
> {
  constructor(kvStore: KVStore, chainId: string, chainGetter: ChainGetter) {
...
export class ObservableQueryGovParamDeposit extends ObservableChainQuery<
  GovParamsDeposit
> {
  constructor(kvStore: KVStore, chainId: string, chainGetter: ChainGetter) {
